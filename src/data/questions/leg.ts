...
export const QUESTOES_LEG: Question[] = [
  {
    ...
    enunciado:
      "No regime disciplinar dos servidores públicos civis do Estado do Paraná, a apuração de infrações disciplinares mais graves, que podem resultar em demissão, é feita, em regra, por meio de:",
    alternativas: [
      "Simples memorando interno da chefia imediata",
      "Processo Administrativo Disciplinar (PAD), assegurados contraditório e ampla defesa",
      "Decisão unilateral do Secretário de Segurança Pública, sem necessidade de defesa",
      "Inquérito policial militar",
      "Notificação extrajudicial",
    ],
    correta: 1,
    explicacao:
      "Infrações disciplinares mais graves exigem processo administrativo disciplinar formal, no qual são assegurados ao servidor o contraditório e a ampla defesa, princípios constitucionais aplicáveis a qualquer processo administrativo sancionador.",
    origem: "banco",
  },
  {
    id: "leg-002",
    materia: "leg",
    topico: "Estatuto do servidor estadual",
    enunciado:
  ...
  },
  {
    ...
    topico: "Regime disciplinar",
    enunciado:
      "No âmbito do regime disciplinar dos servidores estaduais, o princípio segundo o qual ninguém pode ser punido sem que a conduta esteja previamente definida como infração em lei ou regulamento é o princípio da:",
    alternativas: ["Proporcionalidade", "Legalidade (tipicidade disciplinar)", "Publicidade", "Impessoalidade", "Eficiência"],
    correta: 1,
    explicacao:
      "O princípio da legalidade (e, no âmbito disciplinar, da tipicidade) exige que a conduta punível esteja previamente prevista em lei ou regulamento, vedando-se punições por analogia ou por condutas não tipificadas.",
    origem: "banco",
  },
  {
    id: "leg-005",
    ...
    topico: "Estatuto do servidor estadual",
    enunciado:
      "A vacância do cargo público estadual pode ocorrer, entre outras hipóteses, por:",
    alternativas: [
      ...
      "Somente após 30 anos de serviço",
      "Transferência de setor dentro do mesmo órgão",
    ],
    correta: 1,
    explicacao:
      "A vacância é a situação do cargo público sem titular, decorrente de hipóteses legais como exoneração, demissão, aposentadoria, promoção (quando implica mudança de cargo) e falecimento do servidor.",
    origem: "banco",
  },
  {
    id: "leg-006",
  ...
  },
  {
    ...
    enunciado:
      "Segundo a LC Estadual nº 259/2023, que disciplina o regime jurídico do Quadro Próprio da Polícia Civil (QPPC) do Paraná, é vedado ao servidor policial civil o exercício de outra atividade remunerada, pública ou privada, EXCETO:",
    alternativas: [
      "Atividade comercial autônoma",
      "O magistério",
      "Cargo de direção em empresa privada",
      "Consultoria jurídica remunerada",
      "Qualquer atividade, desde que fora do horário de expediente",
    ],
    correta: 1,
    explicacao:
      "A LC 259/2023 veda, em regra, o exercício de outra atividade remunerada pelo servidor policial civil, ressalvando expressamente o magistério — regra semelhante à vedação de acumulação de cargos públicos do art. 37, XVI, da CF, que também excepciona o magistério.",
    origem: "banco",
  },
  {
    id: "leg-011",
    ...
    topico: "LC Estadual 259/2023 (regime jurídico da PCPR)",
    enunciado:
      "Conforme a LC Estadual nº 259/2023 (art. 20), o servidor policial civil recém-ingresso no cargo deve permanecer, em regra, por um período mínimo na macrorregião de seu ingresso antes de poder solicitar remoção. Esse período mínimo é de:",
    alternativas: [
      "1 ano",
      "2 anos",
      "3 anos, com contagem em dobro do tempo de serviço, para fins de promoção, nos casos excepcionais de remoção antecipada",
      "5 anos, sem qualquer exceção",
      "10 anos",
    ],
    correta: 2,
    explicacao:
      "O art. 20 da LC 259/2023 estabelece a permanência mínima de 3 anos na macrorregião de ingresso, prevendo contagem em dobro do tempo de serviço para fins de promoção nos casos excepcionais de remoção antecipada.",
    origem: "banco",
  },
  {
    id: "leg-012",
    ...
    enunciado:
      "A Lei Estadual nº 23.213/2026, Lei Orgânica da Polícia Civil do Paraná, disciplina a estrutura organizacional da instituição, prevendo, entre outros órgãos:",
    alternativas: [
      "O Delegado-Geral da Polícia Civil, o Conselho Superior de Polícia (CSP) e a Corregedoria-Geral",
      "Apenas o cargo de Secretário de Segurança Pública",
      "A subordinação direta da Polícia Civil ao Poder Judiciário estadual",
      "A extinção da carreira de Papiloscopista",
      "A fusão entre Polícia Civil e Polícia Militar em um único órgão",
    ],
    correta: 0,
    explicacao:
      "Por ser legislação recém-editada, a Lei Orgânica da PCPR (Lei 23.213/2026) é apontada pelo material de estudo como tema de alta probabilidade de cobrança literal; estrutura a instituição em torno de órgãos como o Delegado-Geral (chefia máxima da carreira), o Conselho Superior de Polícia (CSP) e a Corregedoria-Geral, responsável pelo controle interno da atividade funcional.",
    origem: "banco",
  },
  {
    id: "leg-013",
